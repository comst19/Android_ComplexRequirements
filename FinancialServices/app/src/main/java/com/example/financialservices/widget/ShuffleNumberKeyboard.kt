package com.example.financialservices.widget
...
import com.example.financialservices.databinding.WidgetShuffleNumberBinding
import kotlin.random.Random

class ShuffleNumberKeyboard @JvmOverloads
constructor(context: Context, arrts: AttributeSet? = null, defStyleAttr: Int = 0) :
    GridLayout(context, arrts, defStyleAttr), View.OnClickListener {

    private var _binding: WidgetShuffleNumberBinding? = null
    private val binding get() = _binding!!

    private var listener : KeyPadListener? = null

    init {
        _binding = WidgetShuffleNumberBinding.inflate(LayoutInflater.from(context), this, true)
        binding.view = this
