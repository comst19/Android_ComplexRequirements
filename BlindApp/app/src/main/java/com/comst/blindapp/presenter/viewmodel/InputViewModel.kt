package com.comst.blindapp.presenter.viewmodel
...
import com.comst.blindapp.domain.usecase.ContentUseCase
...
class InputViewModel @Inject constructor(
    ...
    val donEvent : LiveData<Pair<Boolean, String>> = _doneEvent
